...
/**
 * This class is responsible for calculating number of user answers.
 *
 * @author Farshid Mehrtash
 * @version 1.0.0
 */
class GetCountAnsweredFlashcardsAction
{
    ...
    /**
     * Calculating number of user answers.
     *
     * @param $userId
     * @return int
     *
    ...
    {
        return $this->flashcardRepository->getFlashCardAnswersByUser($userId)->count();
    }
}
